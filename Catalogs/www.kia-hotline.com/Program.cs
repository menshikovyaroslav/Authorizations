...
namespace www.kia_hotline.com
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Address = "https://www.kia-hotline.com/euro5/login.tiles",
                Accept = "text/html, application/xhtml+xml, */*",
                Host = "www.kia-hotline.com",
                KeepAlive = true,
                Proxy = proxy
            };
            ...
            {
                Data = data,
                Address = $"https://www.kia-hotline.com//common/chinalogin.action",
                Accept = "application/json, text/javascript, */*; q=0.01",
                Host = "www.kia-hotline.com",
                ContentType = "application/x-www-form-urlencoded",
                Referer = "https://www.kia-hotline.com/euro5/login.tiles",
                KeepAlive = true,
                Proxy = proxy
            };
            ...
            if (postRequest.Response.Contains("result_code\":\"99"))
            {
                ...
                Config.Instance.AddLogInfo($"Auth good, but you need to change password");
                return;
            }

            getRequest = new GetRequest()
            {
                Address = "https://www.kia-hotline.com/manualV2/euro5/cnts/view/PARTS?euro5=1",
                Accept = "application/json, text/javascript, */*; q=0.01",
                Host = "www.kia-hotline.com",
                KeepAlive = true,
                TimeOut = 60000,
                Referer = "https://www.kia-hotline.com/euro5/index.tiles",
                Proxy = proxy
            };
            getRequest.Run(ref cookies);
            ...
            var group_e = getRequest.Response.IndexOf("\"", group_s + 1);
            var group = getRequest.Response.Substring(group_s, group_e - group_s);

            var id_s = getRequest.Response.IndexOf("\"wpcId\"") + 9;
            var id_e = getRequest.Response.IndexOf("\"", id_s + 1);
            var id = getRequest.Response.Substring(id_s, id_e - id_s);

            var key_s = getRequest.Response.IndexOf("\"wpcKey\"") + 10;
            var key_e = getRequest.Response.IndexOf("\"", key_s + 1);
            var key = getRequest.Response.Substring(key_s, key_e - key_s);

            var nat_s = getRequest.Response.IndexOf("\"natCd\"") + 9;
            var nat_e = getRequest.Response.IndexOf("\"", nat_s + 1);
            var natcd = getRequest.Response.Substring(nat_s, nat_e - nat_s);
