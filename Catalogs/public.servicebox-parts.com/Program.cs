...
namespace servicebox
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            {
                Address = "http://public.servicebox-parts.com/pages/index.jsp",
                Accept = "text/html, application/xhtml+xml, */*",
                Host = "public.servicebox-parts.com",
                KeepAlive = true,
                TimeOut = 10000,
                Proxy = proxy
            };
            ...
            var postRequest = new PostRequest()
            {
                ...
                Address = @"http://public.servicebox-parts.com/do/login",
                Accept = "text/html,application/xhtml+xml,application/xml;q=0.9,*/*;q=0.8",
                Host = "public.servicebox-parts.com",
                ContentType = "application/x-www-form-urlencoded",
                Referer = "http://public.servicebox-parts.com/pages/index.jsp",
                KeepAlive = true,
                Proxy = proxy
            };
            ...
            {
                Address = "http://public.servicebox-parts.com/do/newApvprStart",
                Accept = "text/html, application/xhtml+xml, */*",
                Host = "public.servicebox-parts.com",
                KeepAlive = true,
                Proxy = proxy,
